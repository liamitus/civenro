  ...
  return (
    <div className="mx-auto max-w-2xl px-4 py-10 space-y-8">
      ...
      <section className="space-y-3">
        ...
        <div className="rounded-lg border-2 border-civic-gold/30 bg-civic-cream/30 p-4 space-y-2">
          <p className="text-sm text-foreground leading-relaxed font-medium">
            Please read this section carefully.
          </p>
          <ul className="text-sm text-muted-foreground leading-relaxed list-disc pl-5 space-y-2">
            <li>
              <strong className="text-foreground">AI-generated content may contain errors.</strong>{" "}
      ...
      <section className="space-y-3">
        ...
        <ul className="text-sm text-muted-foreground leading-relaxed list-disc pl-5 space-y-1">
          ...
          <li>Scrape or harvest data from the Service in a way that burdens our systems.</li>
          <li>Use the Service to misrepresent legislative information or create misleading content.</li>
        </ul>
      </section>
